...
prolog:
    ...
    ; Main loop unrolled * 4 below, slower than the std implementation from my host OS libc.
    ; Aligning the pointer to 64-bytes and unrolling 8 times seems to be slower, so I went with just 32-byte
    ; copies.
